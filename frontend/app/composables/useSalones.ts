...
// `BoletaVenta` vive en `~/types/boleta` (tercera copia extraída — ver el
// docblock de ese archivo). Se reexporta acá para no romper a quien ya la
// importa de este composable (`salones/index.vue`).
export type { BoletaVenta } from '~/types/boleta'
