...
y el barrido de las citas al plan y a la spec borrados. Los dos residuos de ese barrido —las
...
`grep -rniE 'tareas? *[0-9]' backend/src backend/test frontend/app --exclude=tmp-pool.jsonl`,
